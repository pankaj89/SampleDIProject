...
abstract class KotprefModel(val context: Context, val gson: Gson) {
    ...
    inline fun <reified T : Any> gsonPref(
        ...
        GsonPref(object : TypeToken<T>() {}.type, default, key, commitByDefault, gson)
